    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo __('Edit bank details'); ?></h3>
            ...
            <!-- /.box-header -->
            <form action="<?php echo url('/setting/bank_details/update/'. $bank_details['id']); ?>" method="post" name="bank_details_edit_form">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo $errors->has('bank_detail_code') ? ' has-error' : ''; ?> has-feedback">
                                <input type="text" name="bank_detail_code" id="bank_detail_code" class="form-control" value="<?php echo $bank_details->bank_detail_code; ?>" placeholder="<?php echo __('Enter bank details code..'); ?>">
                            ...
                            <div class="form-group<?php echo $errors->has('bank_detail_name') ? ' has-error' : ''; ?> has-feedback">
                                <input type="text" name="bank_detail_name" id="bank_detail_name" class="form-control" value="<?php echo $bank_details->bank_detail_name; ?>" placeholder="<?php echo __('Enter bank name..'); ?>">
                            ...
                            <div class="form-group<?php echo $errors->has('bsb_number') ? ' has-error' : ''; ?> has-feedback">
                                <input type="text" name="bsb_number" id="bsb_number" class="form-control" value="<?php echo $bank_details->bsb_number; ?>" placeholder="<?php echo __('Enter bsb number..'); ?>">
                            ...
                            <div class="form-group<?php echo $errors->has('bank_type') ? ' has-error' : ''; ?> has-feedback">
                                <input type="text" name="bank_type" id="bank_type" class="form-control" value="<?php echo $bank_details->bank_type; ?>" placeholder="<?php echo __('Enter bank type..'); ?>">
                            ...
                            <div class="form-group<?php echo $errors->has('bank_phone') ? ' has-error' : ''; ?> has-feedback">
                                <input type="text" name="bank_phone" id="bank_phone" class="form-control" value="<?php echo $bank_details->bank_phone; ?>" placeholder="<?php echo __('Enter bank phone..'); ?>">
                            ...
                            <label for="employment_account_nunber"><?php echo __('Employement Account Number'); ?> <span class="text-danger">*</span></label>
                            <div class="form-group<?php echo $errors->has('employment_account_nunber') ? ' has-error' : ''; ?> has-feedback">
                                <input type="text" name="employment_account_nunber" id="employment_account_nunber" class="form-control" value="<?php echo $bank_details->employment_account_number; ?>" placeholder="<?php echo __('Enter employment account number..'); ?>">
                                <?php if($errors->has('employment_account_nunber')): ?>
                                <span class="help-block">
                                    <strong><?php echo $errors->first('employment_account_nunber'); ?></strong>
                                </span>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="form-group<?php echo $errors->has('account_suffix') ? ' has-error' : ''; ?> has-feedback">
                                <input type="text" name="account_suffix" id="account_suffix" class="form-control" value="<?php echo $bank_details->account_suffix; ?>" placeholder="<?php echo __('Enter account suffix..'); ?>">
                            ...
                            <div class="form-group<?php echo $errors->has('status') ? ' has-error' : ''; ?> has-feedback">
                                <select name="status" id="status" class="form-control">
                                    ...
                                    <option value="1" <?php echo $bank_details->status=='1' ? 'Published': ""; ?>><?php echo __('Published'); ?></option>
                                    <option value="0" <?php echo $bank_details->status=='0' ? 'Unpublished': ""; ?>><?php echo __('Unpublished'); ?></option>
                                </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group<?php echo $errors->has('bank_address') ? ' has-error' : ''; ?> has-feedback">
                                <textarea class="textarea text-description" name="bank_address" id="bank_address" placeholder="<?php echo __('Enter bank address..'); ?>"><?php echo $bank_details->bank_address; ?></textarea>
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i> <?php echo __('Update Bank Department'); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<script type="text/javascript">
    document.forms['bank_details_edit_form'].elements['publication_status'].value = "<?php echo $bank_details->status; ?>";
</script>
