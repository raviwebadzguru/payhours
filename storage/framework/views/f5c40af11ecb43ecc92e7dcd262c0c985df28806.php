...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
           <?php echo __(' AWARD CATEGORY'); ?>

        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo url('/dashboard'); ?>"><i class="fa fa-dashboard"></i> <?php echo __('Dashboard'); ?></a></li>
            <li><a><?php echo __('Setting'); ?></a></li>
            <li class="active"><?php echo __('Manage Award Categories'); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo __('Manage Award Category'); ?></h3>
            ...
            <div class="box-body">
                ...
                <div  class="col-md-6">
                    <a href="<?php echo url('/setting/award_categories/create'); ?>" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i><?php echo __('Add Award Category Lists'); ?> </a>
                </div>
                <div  class="col-md-6">
                    ...
                    <table  class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo __('Award Name/Title'); ?></th>
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                <td><?php echo $sl++; ?></td>
                                <td><?php echo $award_category['award_title']; ?></td>
                                <td><?php echo $award_category['name']; ?></td>
                                ...
                                <td class="text-center">
                                  <a href="<?php echo url('/setting/award_categories/edit/' . $award_category['id']); ?>"><i class="icon fa fa-edit"></i><?php echo __('Edit'); ?> </a>
                                </td>
                            </tr>
