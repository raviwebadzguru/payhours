            ...
            <div class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group<?php echo $errors->has('no_of_dependent') ? ' has-error' : ''; ?>">
                  ...
                  <div class="col-sm-6">
                    <input type="number" name="no_of_dependent" class="form-control" id="no_of_dependent" value="<?php echo $salary['no_of_dependent']; ?>" placeholder="<?php echo __('Enter no. of dependent..'); ?>">
                ...
                <div class="form-group<?php echo $errors->has('basic_salary') ? ' has-error' : ''; ?>">
                  ...
                  <div class="col-sm-6">
                    <input type="number" name="basic_salary" class="form-control" id="basic_salary" value="<?php echo $salary['basic_salary']; ?>" placeholder="<?php echo __('Enter fortnight salary..'); ?>">
                ...
                <div class="form-group<?php echo $errors->has('hrly_salary_rate') ? ' has-error' : ''; ?>">
                  ...
                  <div class="col-sm-6">
                    <input type="number" name="hourrate" class="form-control" id="hourrate" value="<?php echo $salary['hrly_salary_rate']; ?>" placeholder="<?php echo __('Enter working hours..'); ?>">
                ...
                <div class="form-group<?php echo $errors->has('overtime_hr') ? ' has-error' : ''; ?>">
                    ...
                    <div class="col-sm-2">
                      <input type="number" name="overtime_hr" class="form-control" id="overtime_hr" value="<?php echo $salary['overtime_hr']; ?>" placeholder="<?php echo __('Enter overtime hours..'); ?>">
                ...
                <div class="form-group<?php echo $errors->has('overtime_rate') ? ' has-error' : ''; ?>"> -->
                  ...
                  <div class="col-sm-2">
                    <input type="number" name="overtime_rate" class="form-control" id="overtime_rate" value="<?php echo $salary['overtime_rate']; ?>" placeholder="<?php echo __('Enter overtime rate..'); ?>">
                ...
                <div class="form-group<?php echo $errors->has('overtime_amt') ? ' has-error' : ''; ?>"> -->
                  ...
                  <div class="col-sm-2">
                    <input type="number" name="overtime_amt" class="form-control" id="overtime_amt" value="<?php echo $salary['overtime_amt']; ?>" placeholder="<?php echo __('Overtime amount..'); ?>" readonly>
                ...
                <div class="form-group<?php echo $errors->has('sales_comm') ? ' has-error' : ''; ?>">
                  ...
                  <div class="col-sm-6">
                    <input type="number" name="sales_comm" class="form-control" id="sales_comm" value="<?php echo $salary['sales_comm']; ?>" placeholder="<?php echo __('Enter sales commission amount..'); ?>">
            ...
            <div class="box-body">
              ...
              <div class="col-sm-4" style="padding-left: unset;">
                <div class="form-group<?php echo $errors->has('hr_area') ? ' has-error' : ''; ?>">  
                  ...
                  <!-- <div class="col-sm-3"> -->
                    <input type="text" name="hr_area" class="form-control" id="hr_area" value="<?php echo $salary['hr_area']; ?>" placeholder="<?php echo __('Area...'); ?>" readonly="true">
              ...
              <div class="col-sm-5" style="padding-left: unset;">
                <div class="form-group<?php echo $errors->has('hra_amount_per_week') ? ' has-error' : ''; ?>">
                  ...
                  <input type="number" name="hra_amount_per_week" value="<?php echo $salary['hra_amount_per_week']; ?>" class="form-control" id="hra_amount_per_week" placeholder="<?php echo __('Enter amount ..'); ?>">
              ...
              <div class="col-sm-3" style="padding: unset;">
                <div class="form-group<?php echo $errors->has('house_rent_allowance') ? ' has-error' : ''; ?>">
                  ...
                  <input type="number" name="house_rent_allowance" value="<?php echo $salary['house_rent_allowance']; ?>" class="form-control"  id="house_rent_allowance" placeholder="<?php echo __('0'); ?>" readonly>
              ...
              <div class="col-sm-6" style="padding: unset;">
                <div class="form-group<?php echo $errors->has('vehicle_allowance') ? ' has-error' : ''; ?>">
                  ...
                  <input type="number" name="vehicle_allowance" value="<?php echo $salary['vehicle_allowance']; ?>" class="form-control" id="vehicle_allowance" placeholder="<?php echo __('0'); ?>" readonly>
              ...
              <div class="col-sm-6" style="padding-left: unset;">
                <div class="form-group<?php echo $errors->has('meals_allowance') ? ' has-error' : ''; ?>">
                  ...
                  <input type="number" name="meals_allowance" value="<?php echo $salary['meals_allowance']; ?>" class="form-control" id="meals_allowance" placeholder="<?php echo __('0'); ?>" readonly>
              ...
              <div class="col-sm-6" style="padding-left: unset;">
                <div class="form-group<?php echo $errors->has('special_allowance') ? ' has-error' : ''; ?>">
                  ...
                  <input type="number" name="special_allowance" value="<?php echo $salary['special_allowance']; ?>" class="form-control" id="special_allowance" placeholder="<?php echo __('Enter telephone allowance..'); ?>">
              ...
              <div class="form-group<?php echo $errors->has('other_allowance') ? ' has-error' : ''; ?>">
                ...
                <input type="number" name="other_allowance" value="<?php echo $salary['other_allowance']; ?>" class="form-control" id="other_allowance" placeholder="<?php echo __('Enter domestic servant allowance..'); ?>">
              ...
              <div class="col-sm-6" style="padding-left: unset;">
                <div class="form-group<?php echo $errors->has('electricity_allowance') ? ' has-error' : ''; ?>">
                  ...
                  <input type="number" name="electricity_allowance" value="<?php echo $salary['electricity_allowance']; ?>" class="form-control" id="electricity_allowance" placeholder="<?php echo __('Enter electricity allowance..'); ?>">
              ...
              <div class="form-group<?php echo $errors->has('security_allowance') ? ' has-error' : ''; ?>">
                ...
                <input type="number" name="security_allowance" value="<?php echo $salary['security_allowance']; ?>" class="form-control" id="security_allowance" placeholder="<?php echo __('Enter security allowance..'); ?>">
              ...
              <div class="form-group<?php echo $errors->has('provident_fund_contribution') ? ' has-error' : ''; ?>">
                ...
                <input type="number" name="provident_fund_contribution" value="<?php echo $salary['provident_fund_contribution']; ?>" class="form-control" id="provident_fund_contribution" placeholder="<?php echo __('Enter superannuation fund contribution..'); ?>">
            ...
            <div class="box-body">
              <div class="col-sm-4" style="padding-left: unset;">
                <div class="form-group<?php echo $errors->has('tax_deduction_a') ? ' has-error' : ''; ?>">
                  ...
                  <input type="number" name="tax_deduction_a" value="<?php echo $salary['tax_deduction_a']; ?>" class="form-control" id="tax_deduction_a" placeholder="<?php echo __('Enter tax deduction..'); ?>" readonly>
              ...
              <div class="col-sm-8" style="padding-left: unset;">
                <div class="form-group<?php echo $errors->has('tax_deduction_b') ? ' has-error' : ''; ?>">
                  ...
                  <div class="row">
                  <div class="col-sm-6">
                  <input type="number" name="tax_deduction_b" value="<?php echo $salary['tax_deduction_b']; ?>" class="form-control" id="tax_deduction_b" placeholder="<?php echo __('Enter tax deduction..'); ?>" readonly>
                  </div>
                  <div class="col-sm-6">
              ...
              <div class="form-group<?php echo $errors->has('provident_fund_deduction') ? ' has-error' : ''; ?>">
                ...
                <input type="number" name="provident_fund_deduction" value="<?php echo $salary['provident_fund_deduction']; ?>" class="form-control" id="provident_fund_deduction" placeholder="<?php echo __('Enter superannuation fund deduction..'); ?>">
...
<script type="text/javascript">
  ...
  document.forms['employee_salary_form'].elements['resident_status'].value = "<?php echo $salary['resident_status']; ?>";
  document.forms['employee_salary_form'].elements['hr_place'].value = "<?php echo $salary['hr_place']; ?>";
  document.forms['employee_salary_form'].elements['hra_type'].value = "<?php echo $salary['hra_type']; ?>";
  document.forms['employee_salary_form'].elements['va_type'].value = "<?php echo $salary['va_type']; ?>";
