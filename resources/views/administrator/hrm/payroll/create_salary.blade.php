...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">{{ __('Set Salary Details') }}</li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">{{ __('Set Salary Details') }}</h3>
            ...
            <div class="form-horizontal">
              <div class="box-body">
                ...
                <!-- <div class="form-group{{ $errors->has('hr_place') ? ' has-error' : '' }}">
                  <label for="hr_place" class="col-sm-3 control-label">{{ __('Place for HR Allowance') }}</label>
                  <div class="col-sm-3">
                    <select name="hr_place" id="hr_place" class="form-control">
                      ...
                      <option value="{{ $item['loca_name'] }}">{{ $item['places'] }}</option>
                      @endforeach
                    </select>
                ...
                <!-- <div class="form-group{{ $errors->has('annual_basic') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-6">
                    <input type="number" name="yearrate" class="form-control" id="yearrate" value="{{ old('basic_salary') }}" placeholder="{{ __('Enter working hours..') }}">
                ...
                <div class="form-group{{ $errors->has('hrly_salary_rate') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-6">
                    <input type="number" name="hourrate" class="form-control" id="hourrate" value="{{ old('hrly_salary_rate') }}" placeholder="{{ __('Enter working hours..') }}">
                ...
                <div class="form-group{{ $errors->has('overtime_hr') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-2">
                      <input type="number" name="overtime_hr" class="form-control" id="overtime_hr" value="{{ old('overtime_hr') }}" placeholder="{{ __('Enter overtime hours..') }}">
                ...
                <div class="form-group{{ $errors->has('overtime_rate') ? ' has-error' : '' }}"> -->
                  ...
                  <div class="col-sm-2">
                    <input type="number" name="overtime_rate" class="form-control" id="overtime_rate" value="{{ old('overtime_rate') }}" placeholder="{{ __('Enter overtime rate..') }}">
                ...
                <div class="form-group{{ $errors->has('overtime_amt') ? ' has-error' : '' }}"> -->
                  ...
                  <div class="col-sm-2">
                    <input type="number" name="overtime_amt" class="form-control" id="overtime_amt" value="{{ old('overtime_amt') }}" placeholder="{{ __('Overtime amount..') }}" readonly>
                ...
                <div class="form-group{{ $errors->has('sales_comm') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-6">
                    <input type="number" name="sales_comm" class="form-control" id="sales_comm" value="{{ old('sales_comm') }}" placeholder="{{ __('Enter sales commission amount..') }}">
