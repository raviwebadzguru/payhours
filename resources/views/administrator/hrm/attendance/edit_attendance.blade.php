                                    ...
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            @if($attendance['attendance_status'] == 1)
                                                <input type="hidden" name="attendance_status[]" value="1"><input checked type="checkbox" title="Please uncheck for absence" onclick="this.previousSibling.value=1-this.previousSibling.value">
                                            @else
                                                <input type="hidden" name="attendance_status[]" value="0"><input type="checkbox" title="Please uncheck for absence" onclick="this.previousSibling.value=1-this.previousSibling.value">
                                            @endif
                                        </label>
                                    </div>
                                </div>
