                        ...
                        <tr>
                            ...
                            <td  class="text-center">
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            <input type="hidden" name="attendance_status[]" value="1"><input type="checkbox" title="Please uncheck for absence" onclick="this.previousSibling.value=1-this.previousSibling.value" checked>
                                        </label>
                                    </div>
                                </div>
                            </td>
                            ...
                            <!-- <td><input type="time" style="border: none; font-size: small;" value="{{ $employee['in_time'] }}" disabled> - <input type="time" style="border: none; font-size: small;" value="{{ $employee['out_time'] }}" disabled></td> -->
                            <td>{{ $employee['in_time'] }} - {{ $employee['out_time'] }}</td>
                            <td>
                                <div class="form-group">
                                    <!-- <input type="time" name="check_in[]" class="form-control" value="{{$intime}}"> -->
                                    <input type="time" name="check_in[]" class="form-control" value="{{ $employee['in_time'] }}">
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                                    <div class="form-group">
                                        <input type="time" name="check_out[]" class="form-control" value="{{ $employee['out_time'] }}">
                                    </div>
                                </div>
                            </td>
                        </tr>
     ...
     @if($setimes->count()>0)
        ...
        <form action="{{ url('/hrm/attendance/time/set') }}" method="post">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <input type="time" name="in_time" class="form-control" value="{{$intime}}">
                </div>
                <label>{{ __('Out Time') }}<span class="text-danger">*</span></label>
                <div class="form-group">
                    <input type="time" name="out_time" class="form-control" value="{{$outtime}}">
                </div>
            </div>
