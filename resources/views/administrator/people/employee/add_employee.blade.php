                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label for="no_of_dependent" class="control-label">{{ __('No. of Dependent') }}</label>
                                        <div class="form-group">
                                            <input type="number" name="no_of_dependent" class="form-control" id="no_of_dependent" value="{{ $employee['no_of_dependent'] }}" placeholder="{{ __('Enter no. of dependent..') }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <label for="academic_qualification" class="control-label">{{ __('Academic Qualification') }}</label>
                                        <div class="form-group">
                                            <textarea name="academic_qualification" id="academic_qualification" class="form-control textarea" placeholder="{{ __('Enter academic qualification..') }}" readonly>{{ old('academic_qualification') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <label for="professional_qualification" class="control-label">{{ __('Professional Qualification') }}</label>
                                        <div class="form-group">
                                            <textarea name="professional_qualification" id="professional_qualification" class="form-control textarea" placeholder="{{ __('Enter professional qualification..') }}" readonly>{{ old('professional_qualification') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <label for="experience" class="control-label">{{ __('Experience') }}</label>
                                        <div class="form-group">
                                            <textarea name="experience" id="experience" class="form-control textarea" placeholder="{{ __('Enter experience..') }}" readonly>{{ old('experience') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="box box-default">
                                        ...
                                        <div class="box box-info">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="form-group{{ $errors->has('basic_salary') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="number" name="basic_salary" class="form-control" id="basic_salary" value="{{ old('basic_salary') }}" placeholder="{{ __('Enter fortnight salary..') }}">
                                                ...
                                                <div class="form-group{{ $errors->has('hrly_salary_rate') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="number" name="hrly_salary_rate" class="form-control" id="hrly_salary_rate" value="{{ old('hrly_salary_rate') }}" placeholder="{{ __('Enter working hours..') }}">
                        ...
                        @else
                            ...
                            @endphp
                            <form name="employee_salary_form" id="employee_salary_form" action="{{ url('/hrm/payroll/payroll_update/' . $payroll_id) }}" method="post">
                                {{ csrf_field() }}
                                @if (isset($employee_id))
                                <input type="hidden" name="user_id" value="{{ $employee_id }}">
                                        ...
                                        <div class="box box-info">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="form-group{{ $errors->has('annual_basic') ? ' has-error' : '' }}">
                                                    <label for="basic_salary" class="col-sm-3 control-label">{{ __('Annual Salary') }}</label>
                                                    <div class="col-sm-6">
                                                        <input type="number" name="annual_salary" class="form-control" id="annual_salary" value="{{ $payroll->annual_salary }}" placeholder="{{ __('Enter annual salary..') }}">
                                                        @if ($errors->has('annual_salary'))
                                                        <span class="help-block">
                                                        <strong>{{ $errors->first('annual_salary') }}</strong>
                                                        </span>
                                                ...
                                                <div class="form-group{{ $errors->has('hrly_salary_rate') ? ' has-error' : '' }}">
                                                    <label for="hrly_salary_rate" class="col-sm-3 control-label">{{ __('Rate') }}</label>
                                                    <div class="col-sm-6">
                                                        <input type="number" name="hrly_salary_rate" class="form-control" id="hrly_salary_rate" value="{{ $payroll->hrly_salary_rate }}" placeholder="{{ __('Enter working hours..') }}">
                                                        @if ($errors->has('hrly_salary_rate'))
                                                        <span class="help-block">
                                                        <strong>{{ $errors->first('hrly_salary_rate') }}</strong>
                                                        </span>
                                            ...
                                            <!-- Add your form fields here -->
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group{{ $errors->has('employee_contact_email') ? ' has-error' : '' }} has-feedback">
                                                        <input type="text" name="employee_contact_email" id="employee_contact_email" class="form-control" value="{{ $employee_contact->employee_contact_email }}" placeholder="{{ __('Enter employee_contact_email address..') }}">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <!-- /.form-group -->                        </div>
                                    <div class="box-footer">
                                        <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> {{ __('Update Contact') }}</button>
                                    </div>
                                </form>
                                
                            <?php } else { ?>
                                <!-- Insert Employee Contact Form -->
                                <form action="{{ url('/employee_contacts/store/'.$emp_id) }}" method="post" name="employee_add_contact_form">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="user_id" class="form-control" id="user_id" value="{{ $emp_id }}">
                                    <input type="hidden" name="employee_id" class="form-control" id="employee_id" value="{{ $emp_id }}">
                                    <div class="box-body">
                                            <!-- Add your form fields here -->
                                                ...
                                                <div class="col-md-6">
                                                    <label for="employee_contact_email">{{ __('employee_contact_email') }} <span class="text-danger">*</span></label>
                                                    <div class="form-group{{ $errors->has('employee_contact_email') ? ' has-error' : '' }} has-feedback">
                                                        <input type="text" name="employee_contact_email" id="employee_contact_email" class="form-control" value="{{ old('employee_contact_email') }}" placeholder="{{ __('Enter employee_contact_email address..') }}">
                                                        @if ($errors->has('employee_contact_email'))
                                                        <span class="help-block">
                                                            <strong>{{ $errors->first('employee_contact_email') }}</strong>
                                                        </span>
